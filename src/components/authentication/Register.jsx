      ...
      <section className="lg:pt-[50px] pt-[30%] lg:ml-[100px] h-full flex flex-col justify-center w-full sm:mx-[1rem] sm:w-auto sm:text-[1.4rem]">
        <div className="md:mx-auto">
            <Animation animationCreator={itemAnimate.bind(null, 0)}>
              <h1 className="sm:text-[1.2rem] text-white w-max text-3xl font-[600] relative after:w-[10px] after:h-[10px] after:absolute after:rounded-[50%] after:bottom-1 after:right-[-10px] after:bg-blue-400">
                Create new Account
              </h1>
            </Animation>
            ...
            >
              <div className="w-full flex gap-x-3">
                <div className="basis-1/2">
                  <Animation animationCreator={itemAnimate.bind(null, 0.2)} className="basis-1/2">
                    <MyInput
                      ref={firstNameRef}
                ...
                <div className="basis-1/2">
                  <Animation animationCreator={itemAnimate.bind(null, 0.3)} className="basis-1/2">
                    <MyInput
                      ref={lastNameRef} validationFunction={validateEmpty}
